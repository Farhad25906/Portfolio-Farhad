  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-display font-bold">What I Do</h2>
      </div>
      ...
      <FadeIn delay={0.2} className="w-full">
        ...
        <div className="bg-zinc-900 rounded-t-lg border border-zinc-800 px-4 py-3 flex items-center gap-2">
          ...
          <span className="ml-4 text-zinc-400 text-sm font-mono">services.sh</span>
        </div>

        {/* Terminal Body */}
        <div className="bg-black border-x border-b border-zinc-800 rounded-b-lg p-6 font-mono text-sm min-h-[400px]">
          {/* Command List */}
          <div className="mb-6">
            <div className="text-zinc-500 mb-2">$ ls -la services/</div>
              ...
              {services.map((service, index) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-blue-400">{service.command}</span>
                  </div>
                </button>
              ))}
            </div>
