  ...
  <FadeIn className="space-y-8">
    ...
    <div className="relative before:absolute before:left-[19px] before:top-0 before:bottom-0 before:w-[2px] before:bg-blue-500/20 ml-3 space-y-10">
      <div className="pl-10 relative group">
        ...
        <div className="bg-card border-2 border-border hover:border-blue-500/50 p-6 rounded-2xl transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/5">
          <div className="flex items-center gap-3 mb-3">
            <span className="text-xs text-blue-500 font-bold tracking-widest uppercase px-3 py-1 bg-blue-500/10 rounded-full">December 2024 - December 2025</span>
      ...
      <div className="pl-10 relative group">
        ...
        <div className="bg-card border-2 border-border hover:border-blue-500/50 p-6 rounded-2xl transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/5">
          <div className="flex items-center gap-3 mb-3">
            <span className="text-xs text-blue-500 font-bold tracking-widest uppercase px-3 py-1 bg-blue-500/10 rounded-full">March 2026 - Present</span>
            <span className="text-xs text-muted-foreground">Full-time</span>
          </div>
          <h3 className="text-2xl font-bold mb-1">Frontend Developer</h3>
          <p className="text-lg text-blue-500 font-semibold mb-4">World Tech</p>
          <ul className="space-y-2.5 text-muted-foreground">
            <li className="flex items-start gap-3">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 flex-shrink-0"></span>
              <span className="leading-relaxed">Building modern, scalable user interfaces with Next.js and modern UI systems.</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 flex-shrink-0"></span>
              <span className="leading-relaxed">Collaborating closely with design and product teams to deliver polished experiences.</span>
            </li>
          </ul>
        </div>
      </div>
